...
| **Runa** (the miller) | Arrives via the Boarding House | Works the player's Mill: bulk grain via hand-production; hire (after her house is built) → automation. First proof of Elias's newcomer pipeline | New, 2026-08-04 — the endgame hire |
